...
/**
 * <p>Clase Java para RegistraCvesSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="RegistraCvesSegResponseType">
 *   <complexContent>
...
@XmlType(name = "RegistraCvesSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class RegistraCvesSegResponseType {
