...
/**
 * <p>Clase Java para ValidaFirmaXMLSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaFirmaXMLSegResponseType">
 *   <complexContent>
...
@XmlType(name = "ValidaFirmaXMLSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class ValidaFirmaXMLSegResponseType {
