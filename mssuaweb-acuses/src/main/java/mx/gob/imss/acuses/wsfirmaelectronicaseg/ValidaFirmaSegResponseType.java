...
/**
 * <p>Clase Java para ValidaFirmaSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaFirmaSegResponseType">
 *   <complexContent>
...
@XmlType(name = "ValidaFirmaSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class ValidaFirmaSegResponseType {
