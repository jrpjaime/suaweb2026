...
/**
 * <p>Clase Java para FirmaLoteRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="FirmaLoteRequestType">
 *   <complexContent>
...
@XmlType(name = "FirmaLoteRequestType", propOrder = {
    "jsonParams"
})
public class FirmaLoteRequestType {
