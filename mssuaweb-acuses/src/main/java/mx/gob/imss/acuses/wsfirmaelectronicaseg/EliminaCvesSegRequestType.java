...
/**
 * <p>Clase Java para EliminaCvesSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="EliminaCvesSegRequestType">
 *   <complexContent>
...
@XmlType(name = "EliminaCvesSegRequestType", propOrder = {
    "jsonParms"
})
public class EliminaCvesSegRequestType {
