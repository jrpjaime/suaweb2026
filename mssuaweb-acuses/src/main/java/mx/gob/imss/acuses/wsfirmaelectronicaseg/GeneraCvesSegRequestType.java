...
/**
 * <p>Clase Java para GeneraCvesSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GeneraCvesSegRequestType">
 *   <complexContent>
...
@XmlType(name = "GeneraCvesSegRequestType", propOrder = {
    "jsonParms"
})
public class GeneraCvesSegRequestType {
