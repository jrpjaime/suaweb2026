...
/**
 * <p>Clase Java para GetSignerDataResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GetSignerDataResponseType">
 *   <complexContent>
...
@XmlType(name = "GetSignerDataResponseType", propOrder = {
    "resultado",
    "jsonResp"
})
public class GetSignerDataResponseType {
