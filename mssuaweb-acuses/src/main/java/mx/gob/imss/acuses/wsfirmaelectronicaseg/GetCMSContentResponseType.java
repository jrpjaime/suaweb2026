...
/**
 * <p>Clase Java para GetCMSContentResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GetCMSContentResponseType">
 *   <complexContent>
...
@XmlType(name = "GetCMSContentResponseType", propOrder = {
    "resultado",
    "jsonResp"
})
public class GetCMSContentResponseType {
