...
/**
 * <p>Clase Java para GeneraCvesSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GeneraCvesSegResponseType">
 *   <complexContent>
...
@XmlType(name = "GeneraCvesSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class GeneraCvesSegResponseType {
