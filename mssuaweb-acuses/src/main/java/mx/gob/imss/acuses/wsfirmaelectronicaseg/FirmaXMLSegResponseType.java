...
/**
 * <p>Clase Java para FirmaXMLSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="FirmaXMLSegResponseType">
 *   <complexContent>
...
@XmlType(name = "FirmaXMLSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class FirmaXMLSegResponseType {
