...
/**
 * <p>Clase Java para ValidaFirmaXMLSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaFirmaXMLSegRequestType">
 *   <complexContent>
...
@XmlType(name = "ValidaFirmaXMLSegRequestType", propOrder = {
    "jsonParms"
})
public class ValidaFirmaXMLSegRequestType {
