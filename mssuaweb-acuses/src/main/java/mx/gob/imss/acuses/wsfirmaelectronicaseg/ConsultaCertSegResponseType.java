...
/**
 * <p>Clase Java para ConsultaCertSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ConsultaCertSegResponseType">
 *   <complexContent>
...
@XmlType(name = "ConsultaCertSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class ConsultaCertSegResponseType {
