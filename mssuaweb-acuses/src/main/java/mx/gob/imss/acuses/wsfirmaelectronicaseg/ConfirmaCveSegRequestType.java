...
/**
 * <p>Clase Java para ConfirmaCveSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ConfirmaCveSegRequestType">
 *   <complexContent>
...
@XmlType(name = "ConfirmaCveSegRequestType", propOrder = {
    "jsonParms"
})
public class ConfirmaCveSegRequestType {
