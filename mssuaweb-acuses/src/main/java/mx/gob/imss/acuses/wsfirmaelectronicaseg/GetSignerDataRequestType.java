...
/**
 * <p>Clase Java para GetSignerDataRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GetSignerDataRequestType">
 *   <complexContent>
...
@XmlType(name = "GetSignerDataRequestType", propOrder = {
    "jsonParams"
})
public class GetSignerDataRequestType {
