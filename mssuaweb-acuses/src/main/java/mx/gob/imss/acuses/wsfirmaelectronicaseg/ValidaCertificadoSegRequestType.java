...
/**
 * <p>Clase Java para ValidaCertificadoSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaCertificadoSegRequestType">
 *   <complexContent>
...
@XmlType(name = "ValidaCertificadoSegRequestType", propOrder = {
    "jsonParams"
})
public class ValidaCertificadoSegRequestType {
