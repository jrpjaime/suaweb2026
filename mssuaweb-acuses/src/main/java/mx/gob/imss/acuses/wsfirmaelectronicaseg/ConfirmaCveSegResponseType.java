...
/**
 * <p>Clase Java para ConfirmaCveSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ConfirmaCveSegResponseType">
 *   <complexContent>
...
@XmlType(name = "ConfirmaCveSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class ConfirmaCveSegResponseType {
