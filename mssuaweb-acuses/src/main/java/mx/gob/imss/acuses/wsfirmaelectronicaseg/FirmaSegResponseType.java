...
/**
 * <p>Clase Java para FirmaSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="FirmaSegResponseType">
 *   <complexContent>
...
@XmlType(name = "FirmaSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class FirmaSegResponseType {
