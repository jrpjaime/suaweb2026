...
/**
 * <p>Clase Java para RegistroSeguimientoResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="RegistroSeguimientoResponseType">
 *   <complexContent>
...
@XmlType(name = "RegistroSeguimientoResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class RegistroSeguimientoResponseType {
