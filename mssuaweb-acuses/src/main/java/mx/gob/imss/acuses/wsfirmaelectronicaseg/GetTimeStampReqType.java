...
/**
 * <p>Clase Java para GetTimeStampReqType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GetTimeStampReqType">
 *   <complexContent>
...
@XmlType(name = "GetTimeStampReqType", propOrder = {
    "jsonSolicitud"
})
public class GetTimeStampReqType {
