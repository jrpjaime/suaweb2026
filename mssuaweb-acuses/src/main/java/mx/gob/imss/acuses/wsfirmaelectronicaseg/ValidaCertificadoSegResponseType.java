...
/**
 * <p>Clase Java para ValidaCertificadoSegResponseType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaCertificadoSegResponseType">
 *   <complexContent>
...
@XmlType(name = "ValidaCertificadoSegResponseType", propOrder = {
    "resultado",
    "jsonSalida"
})
public class ValidaCertificadoSegResponseType {
