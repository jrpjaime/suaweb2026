...
/**
 * <p>Clase Java para GetTimeStampRespType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="GetTimeStampRespType">
 *   <complexContent>
...
@XmlType(name = "GetTimeStampRespType", propOrder = {
    "resultado",
    "jsonResp"
})
public class GetTimeStampRespType {
