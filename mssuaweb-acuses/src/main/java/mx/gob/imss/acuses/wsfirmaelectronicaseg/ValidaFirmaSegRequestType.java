...
/**
 * <p>Clase Java para ValidaFirmaSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ValidaFirmaSegRequestType">
 *   <complexContent>
...
@XmlType(name = "ValidaFirmaSegRequestType", propOrder = {
    "jsonParms"
})
public class ValidaFirmaSegRequestType {
