...
/**
 * <p>Clase Java para RegistraCvesSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="RegistraCvesSegRequestType">
 *   <complexContent>
...
@XmlType(name = "RegistraCvesSegRequestType", propOrder = {
    "jsonParms"
})
public class RegistraCvesSegRequestType {
