...
/**
 * <p>Clase Java para RegistroSeguimientoRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="RegistroSeguimientoRequestType">
 *   <complexContent>
...
@XmlType(name = "RegistroSeguimientoRequestType", propOrder = {
    "jsonParms"
})
public class RegistroSeguimientoRequestType {
