...
/**
 * <p>Clase Java para ConsultaCertSegRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>{@code
 * <complexType name="ConsultaCertSegRequestType">
 *   <complexContent>
...
@XmlType(name = "ConsultaCertSegRequestType", propOrder = {
    "jsonParms"
})
public class ConsultaCertSegRequestType {
